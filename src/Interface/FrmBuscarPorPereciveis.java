 ...
 */
public class FrmBuscarPorPereciveis extends javax.swing.JInternalFrame {

    /**
     * Creates new form FrmBuscarPorPereciveis
     */
    public FrmBuscarPorPereciveis() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("BUSCAR POR PERECIVEIS");
    ...
    private void btProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProcurarActionPerformed
        ...
        try {
            testeLabel.setText(gr.listarPereciveis());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "NÃO FOI ENCONTRADO NENHUM PRODUTO PERECÍVEL", "ERROR", JOptionPane.WARNING_MESSAGE);
        }
