 ...
 */
public class FrmBuscarPorMoveis extends javax.swing.JInternalFrame {

    /**
     * Creates new form FrmBuscarPorMoveis
     */
    public FrmBuscarPorMoveis() {
        initComponents();
    }
    ...
    private void btProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProcurarActionPerformed
        ...
        try {
            testeLabel.setText(gr.listarMoveis());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "NÃO FOI ENCONTRADO NENHUM MOVEL", "ERROR", JOptionPane.WARNING_MESSAGE);
        }
